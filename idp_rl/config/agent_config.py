...
import torch
from idp_rl.models import RTGNGatRecurrent
...
class Config:
    ...
    curriculum_agent_buffer_len : int, required by all curriculum agents
        ...
        See :meth:`~idp_rl.agents.curriculum_agents.ExternalCurriculumAgentMixin.update_curriculum` for more details on how
