...
class BaseAgent:
    ...
    def evaluate(self) -> None:
        ...
        Information dict returned by the environment's :meth:`idp_rl.environments.conformer_env.ConformerEnv.step` method
