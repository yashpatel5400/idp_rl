...
from idp_rl.environments.environment_components import molecule_features

from typing import List, Tuple

class GraphObsMixin:
    """Represents molecule as a PyTorch Geometric graph where no information is included for each (node) and each edge
    is represented by a 6-tuple as generated by :func:`~idp_rl.environments.environment_components.molecule_features.bond_type`.
    """
    def _obs(self) -> Tuple[Batch, List[List[int]]]:
        ...
        node_features = [[] for atom in atoms]
        ...
        return data, self.nonring_backbone
